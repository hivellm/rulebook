...
export async function generateAgentsContent(config: ProjectConfig): Promise<string> {
  ...
  sections.push('');
  sections.push('This project uses a **persistent memory system** via the Rulebook MCP server.');
  sections.push('Memory persists across sessions — use it to maintain context between conversations.');
  sections.push('');
  sections.push('**MANDATORY: You MUST actively use memory to preserve context.**');
  sections.push('');
  ...
  sections.push('- **Fix a bug** — what caused it and how it was resolved');
  sections.push('- **Discover something important** — codebase patterns, gotchas, constraints');
  sections.push('- **Implement a feature** — what was built, key design choices, trade-offs');
  ...
  sections.push('- **Complete a task or session** — summarize what was accomplished');
  sections.push('');
  sections.push('### How to Save');
  sections.push('');
  sections.push('Use the `rulebook_memory_save` MCP tool:');
  sections.push('```');
  sections.push('type: decision | bugfix | feature | discovery | change | refactor | observation');
  sections.push('title: Short descriptive title');
  sections.push('content: Detailed context (what, why, how)');
  sections.push('tags: [relevant, tags]');
  sections.push('```');
  sections.push('');
  sections.push('### When to Search Memory');
  sections.push('');
  sections.push('**At the START of every new session**, search memory for relevant context:');
  sections.push('```');
  sections.push('rulebook_memory_search: query="<current task or topic>"');
  sections.push('```');
  sections.push('');
