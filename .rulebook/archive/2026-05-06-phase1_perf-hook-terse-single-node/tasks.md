...
- [x] 2.2 Write tests covering the new behavior (existing `tests/terse-hooks-shell.test.ts` 31 tests cover the refactor; passes confirm behavior preservation)
- [x] 2.3 Run tests and confirm they pass (31/31)
