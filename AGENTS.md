...
Generated at: 2026-04-07T22:15:35.241Z
...
- **Conditional @imports via line-marker substitution, not template engine** → [spec](/.rulebook/knowledge/patterns/conditional-imports-via-line-marker-substitution-not-template-engine.md)
- **Opt-out sentinel for generated files in user-editable locations** → [spec](/.rulebook/knowledge/patterns/opt-out-sentinel-for-generated-files-in-user-editable-locations.md)

### Anti-Patterns to Avoid

- **Never awk-slice TS source after a previous Edit — line numbers shift** → [details](/.rulebook/knowledge/anti-patterns/never-awk-slice-ts-source-after-a-previous-edit-line-numbers-shift.md)
...
For comprehensive Rulebook mcp-specific instructions, see `/.rulebook/specs/RULEBOOK_MCP.md`
...
| Languages | TypeScript | TypeScript language rules with strict mode, testing, linting, and CI/CD best practices |
| Languages | Typescript | **CRITICAL**: Execute these commands after EVERY implementation (see AGENT_AUTOMATION module for full workflow). |
...
<!-- RULEBOOK:SKILL:languages/typescript:START -->
...
<!-- RULEBOOK:SKILL:languages/typescript:END -->
...
> **Project context**: Primary language is **typescript**. Agents are pre-configured with this context.
