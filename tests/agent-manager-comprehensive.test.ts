...
describe('Agent Manager Comprehensive Tests', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should handle initialization errors', async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith('Failed to initialize Agent Manager', { error: 'Initialization failed' });
    });
  });
  ...
  describe('Agent Workflow Execution', () => {
    ...
    it('should execute task workflow successfully', async () => {
      ...
      expect(mockCLIBridge.sendCommitCommand).toHaveBeenCalledWith('cursor-agent', expect.stringContaining('Test Task'));
    });
  ...
  describe('Agent Workflow Loop', () => {
    ...
    it('should handle workflow iteration failures', async () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith('Workflow iteration 2 failed', { error: 'Workflow error' });
    });
